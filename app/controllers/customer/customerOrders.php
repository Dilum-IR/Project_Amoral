...
class CustomerOrders extends Controller
{
    ...
    public function updateOrder(){
        ...
        if (isset($_POST) && $_SESSION['USER']->user_status === 'customer') {
            $arr['user'] = false;
            $order_id = $_POST['order_id'];
            ...
            if($order_details[0]->order_status != 'delivered'){
                ...
                if($order_details[0]->order_status == 'pending'){
                ...
                $order->update($order_id, ['order_status' => 'completed'], 'order_id');
                $arr['user'] = true;
    ...
    public function cancelOrder(){
        ...
        if (isset($_POST) && $_SESSION['USER']->user_status === 'customer') {
            $order_id = $_POST['order_id'];
            $order->update($order_id, ['order_status' => 'canceled'], 'order_id');
            $arr['user'] = true;

...
<head>
    ...
    <link rel="stylesheet" href="<?= ROOT ?>/assets/css/merchandiser/profile.css">
                ...
                <div class="left">
                    <div class="left-part">
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="change_image" name="change_Image" value="changed">Change
                                Image</button>
                        </form>
                        <p class="image-error">
                            <?=
                    ...
                    <div class="info">
                        ...
                        <form method="POST">
                            ...
                            if (isset($data)) {
                                ...
                                <div class="info_data">
                                    <div class="data">
                                        <label class="pro_label" for="pro_username"><i class='bx bx-user'></i> Full Name
                                ...
                                <div class="info_data">
                                    ...
                                    <div class="data">
                                        <label class="pro_label" for="pro_date">Date of Birth &nbsp; <span
                                                class="data-error">
                                                <?=
                                        ...
                                        <input class="pro_input" type="date" id="pro_date" name="DOB"
                                ...
                                <div class="info_data" id="last-element">
                                    <div class="data">
                                        <label class="pro_label" for="pro_profession">Profession&nbsp; <span
                                                class="data-error">
                                                <?=
                                    ...
                                    <div class="pro_button">
                                        <button type="submit" class="small_btn discard_btn ltor-button" name="discard"
                                            value="discard" href="<?= ROOT ?>/manager/profile">
                                            <span>
                                        ...
                                        <button type="submit" class="small_btn save_btn rtol-button" name="save"
                                            value="save">
                                            <span>
                                                Save Changes
                                            </span>
                                ...
                                <div class="data">
                                    ...
                                    <span class="hide-icon">
                                        <input class="pro_input" type="password" id="c-password" name="password"
                                            ...
                                            value="<?= isset($pass) ? $pass['password'] : "" ?>">
                                        <a href="#" class="hide active"
                                            onclick="togglePasswordVisibility('c-password','c-toggleIcon')">
                                ...
                                <div class="data">
                                    ...
                                    <span class="hide-icon">
                                        ...
                                        <input class="pro_input" type="password" id="n-password" name="new_password"
                                            ...
                                            value="<?= isset($pass) ? $pass['new_password'] : "" ?>">
                                        <a href="#" class="hide active"
                                            onclick="togglePasswordVisibility('n-password','n-toggleIcon')">
                            ...
                            <div class="info_data" id="last-element">
                                <div class="data">
                                    ...
                                    <span class="hide-icon">
                                        ...
                                        <input class="pro_input" type="password" id="re-password"
                                            name="confirm_password" placeholder="Enter Confirm password"
                                            value="<?= isset($pass) ? $pass['confirm_password'] : "" ?>">
                                        <a href="#" class="hide active"
                                            onclick="togglePasswordVisibility('re-password','re-toggleIcon')">
                                            <ion-icon name="eye-off-outline" id="re-toggleIcon"></ion-icon>
                                        </a>
                                    </span>
                                </div>
                                <div class="pro_button">
                                    <button type="submit" class="small_btn discard_btn ltor-button" name="discardP"
                                        value="discardP" href="<?= ROOT ?>/manager/profile">
                                        <span>
                                            Discard
                                        </span>

                                    </button>
                                    <button type="submit" class="small_btn save_btn rtol-button" name="saveP"
                                        value="saveP">
                                        <span>
                                            Save Changes
                                        </span>

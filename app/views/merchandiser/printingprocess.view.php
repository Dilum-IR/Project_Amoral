...
<head>
    ...
    <link rel="stylesheet" href="<?= ROOT ?>/assets/css/merchandiser/printingprocess.css">
...
<body>
                    ...
                    <tbody>
                        ...
                        <?php if(!empty($data['orders'])): ?>
                            <?php foreach($data['orders'] as $order): ?>
                                <?php if($order->order_id !== null && $order->emp_id == $_SESSION['USER']->emp_id && ($order->status == 'sent to company')): ?>
                                    <?php $x++; ?>
    ...
    <script>
        ...
        var change_status_endpoint = "<?php echo ROOT . '/merchandiser/updateOrderStatus'; ?>";
    </script>
    ...
    <script src="<?= ROOT ?>/assets/js/merchandiser/printingprocess.js"></script>

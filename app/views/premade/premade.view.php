                    ...
                    <div class="slide flex-container">
                        ...
                        <div class="div-1-1">
                            <div class="image-container">
                                <img class="pre-design" src="<?= ROOT ?>/assets/images/premade/<?php echo $imageFileNames[$imageIndex] ?>" alt="">
                        ...
                        <div class="div-1-2">
                            <div class="image-container">
                                <img class="pre-design" src="<?= ROOT ?>/assets/images/premade/<?php echo $imageFileNames[$imageIndex + 1] ?>" alt="">
                                <div class="place-order-button">
                        ...
                        <div class="div-1-3">
                            <div class="image-container">
                                <img class="pre-design" src="<?= ROOT ?>/assets/images/premade/<?php echo $imageFileNames[$imageIndex + 3] ?>" alt="">
                                <div class="place-order-button">
